...
namespace GloboMart.App.Test.DependencyResolution
{
    ...
    public class DefaultRegistry : Registry
    {
        ...
        {
            // Register all types
            For<IProductRepository>().Use<MockProductService>();
            For<IDataAccessRepository<Product>>().Use<MockProductDataAccess>();
        }
